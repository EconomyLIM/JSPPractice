...
<header class="sticky">
  ...
  <tr>
         ...
         <tr>
            ...
            <td><input type="text" name="title" size="50" required="required"
            value="${dto.title }"></td>
         </tr>
         <tr>
            <td align="center">내용</td>
            <td><textarea name="content" cols="50" rows="10" value="${dto.content }"></textarea></td>
         </tr>
         <tr>
...
$("form").submit(function(event) {
	alert("유효성 검사 한 후");
	/* event.preventDefault() 이벤트 취소(서브밋취소)*/
})
</script>
</body>
</html>